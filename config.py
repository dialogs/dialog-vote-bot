...
config = {'ELSE' : 'Я вас не понимаю. Вот список доступных команд: \n /start - создать новый опрос',
          ...
          'PUBLISH_INFO' : 'Проверьте, есть ли я в группе, в которую вы хотите отправить сообщение, и перешлите в нее или напишите в ней следующее сообщение:',
          'WRONG_MESSAGE' : 'Ваша команда неправильная'
